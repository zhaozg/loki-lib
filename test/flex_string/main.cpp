...
typedef flex_string<char, std::char_traits<char>, mallocator<char>,
...
template <class String> String RandomString(size_t maxSize) {
...
template <class String> typename String::value_type NullTerminator() {
  return '\0';
}

template <class String> String LengthErrorExceptionString() {
  return "length_error exception thrown";
}

template <class String> String OutOfRangeExceptionString() {
  return "out_of_range exception thrown";
}

template <class String> String UnknownExceptionString() {
  return "Unknown exception thrown";
}

template <class String> String NposString() { return "{npos}"; }

template <class String> String OpenCurlyString() { return "{"; }

template <class String> String CloseCurlyString() { return "}"; }

template <class String> String SeparatorString() { return "--"; }

template <class String> String TrueString() { return "{true}"; }

template <class String> String FalseString() { return "{false}"; }

template <class String, class Integral> String Num2String(Integral value) {
  typedef typename String::value_type CharType;
  std::basic_ostringstream<CharType, std::char_traits<CharType>,
...
template <class String> String Num2String(typename String::size_type value) {
  if (String::npos != value) {
    ...
    // Since methods like find return npos on failure we want to represent npos
    // in an implementation-independent manner.
    return NposString<String>();
  }
}

template <class String> String Num2String(bool value) {
  return value ? TrueString<String>() : FalseString<String>();
}

// Some comparison functions return 0 or a value greater/smaller than zero.
// This function makes the greater/smaller than zero specification
// implementation-independent.
template <class String> String Tristate2String(int tristate) {
  if (0 == tristate)
...
std::list<typename String::value_type>
RandomList(typename String::size_type maxSize) {
  const typename String::size_type size = random(0, maxSize);
...
namespace Tests {
template <class String> struct MaxString {
  static const typename String::size_type value = 1050;
};

template <class String> String operator_plus_string_string() {
  // 21.3
...
template <class String> String operator_plus_cstr_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_plus_char_string() {
  // 21.3
...
template <class String> String operator_plus_string_cstr() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_plus_string_char() {
  // 21.3
  const typename String::value_type value = random('a', 'z');
  String random1(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_equal_equal_string_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_equal_equal_cstr_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_equal_equal_string_cstr() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_not_equal_string_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_not_equal_cstr_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_not_equal_string_cstr() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_smaller_string_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_smaller_cstr_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_smaller_string_cstr() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_greater_string_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_greater_cstr_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_greater_string_cstr() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_smaller_equal_string_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_smaller_equal_cstr_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_smaller_equal_string_cstr() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_greater_equal_string_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_greater_equal_cstr_string() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_greater_equal_string_cstr() {
  // 21.3
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String swap_string_string() {
  // 21.3.7.8
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String swap_string_string__self() {
  // 21.3.7.8
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String swap_string_string__selfcopy() {
  // 21.3.7.8
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  swap(random1, copy);
...
template <class String> String swap_string_string__selfcopy2() {
  // 21.3.7.8
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  swap(copy, random1);
...
template <class String> String constructor() {
  // 21.3.1
  return String();
}

template <class String> String constructor_string() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
  return random1;
}

template <class String> String constructor_string_position_number() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number =
      random(0, random1.size() - position);
  String result(random1, position, number);
  return result;
}

template <class String> String constructor_string_position_number__bigNumber() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String constructor_cstr_number() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String constructor_number_char() {
  // 21.3.1
...
template <class String> String constructor_iterator_iterator() {
  // 21.3.5
  std::list<typename String::value_type> list(
      RandomList<String>(MaxString<String>::value));
...
String constructor_iterator_iterator__istream_iterator() {
  ...
  stream << random1;
  std::istreambuf_iterator<value_type, std::char_traits<value_type>> begin(
      stream),
      end;
...
template <class String> String operator_equal_string() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  random1 = random2;
...
template <class String> String operator_equal_string__self() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
  random1 = random1;
  return random1;
...
template <class String> String operator_equal_string__selfCopy() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String operator_equal_cstr() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String operator_equal_cstr__self() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String operator_equal_cstr__selfCopy() {
  // 21.3.1
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(random1);
  random1 = random2.c_str();
...
template <class String> String iterators() {
  // 21.3.2
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String capacity() {
  // 21.3.3
  String random1(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String resize_number_char() {
  // 21.3.3
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type number = random(0, MaxString<String>::value);
  const typename String::value_type value = random('a', 'z');
...
template <class String> String resize_number() {
  // 21.3.3
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type number = random(0, MaxString<String>::value);
...
template <class String> String reserve_number() {
  // 21.3.3
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type number = random(0, MaxString<String>::value);
...
template <class String> String clear() {
  // 21.3.3
  String random1(RandomString<String>(MaxString<String>::value));
  random1.clear();
  return random1;
...
template <class String> String empty() {
  // 21.3.3
  String random1(RandomString<String>(MaxString<String>::value));
  return Num2String<String>(random1.empty());
}

template <class String> String element_access() {
  // 21.3.4
  String random1(RandomString<String>(MaxString<String>::value));
  const String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String operator_plus_equal_string() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  random1 += random2;
...
template <class String> String operator_plus_equal_string__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  random1 += random1;
  return random1;
...
template <class String> String operator_plus_equal_string__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  random1 += copy;
...
template <class String> String operator_plus_equal_cstr() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  random1 += random2.c_str();
...
template <class String> String operator_plus_equal_cstr__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  random1 += random1.c_str();
  return random1;
...
template <class String> String operator_plus_equal_cstr__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  random1 += copy.c_str();
...
template <class String> String operator_plus_equal_char() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::value_type value = random('a', 'z');
  random1 += value;
...
template <class String> String append_string() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String append_string__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String append_string__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  random1.append(copy);
...
template <class String> String append_string_position_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String append_string_position_number__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
...
template <class String> String append_string_position_number__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String append_cstr_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String append_cstr_number__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type number = random(0, random1.size());
...
template <class String> String append_cstr_number__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type number = random(0, random1.size());
...
template <class String> String append_cstr() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String append_cstr__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String append_cstr__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
...
template <class String> String append_number_char() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type number = random(0, MaxString<String>::value);
  const typename String::value_type value = random('a', 'z');
...
template <class String> String append_iterator_iterator() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  std::list<typename String::value_type> list(
      RandomList<String>(MaxString<String>::value));
...
template <class String> String append_iterator_iterator__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String append_iterator_iterator__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
...
template <class String> String append_iterator_iterator__self_reverse() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String append_iterator_iterator__selfcopy_reverse() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
...
template <class String> String append_iterator_iterator__istream_iterator() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  typedef typename String::value_type value_type;
...
template <class String> String push_back_char() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::value_type value = random('a', 'z');
...
template <class String> String assign_string() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String assign_string__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String assign_string__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  random1.assign(copy);
...
template <class String> String assign_string_position_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random2.size());
...
template <class String> String assign_string_position_number__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
...
template <class String> String assign_string_position_number__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String assign_cstr_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type number = random(0, random2.size());
...
template <class String> String assign_cstr_number__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type number = random(0, random1.size());
...
template <class String> String assign_cstr_number__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const String copy(random1);
...
template <class String> String assign_cstr() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String assign_cstr__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String assign_cstr__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const String copy(random1);
...
template <class String> String assign_number_char() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type number = random(0, MaxString<String>::value);
  const typename String::value_type value = random('a', 'z');
...
template <class String> String assign_iterator_iterator() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  std::list<typename String::value_type> list(
      RandomList<String>(MaxString<String>::value));
...
template <class String> String assign_iterator_iterator__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String assign_iterator_iterator__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
...
template <class String> String assign_iterator_iterator__self_reverse() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String assign_iterator_iterator__selfcopy_reverse() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
...
template <class String> String assign_iterator_iterator__istream_iterator() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  typedef typename String::value_type value_type;
...
template <class String> String insert_position_string() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_position_string__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_position_string__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_position_string_position_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String insert_position_string_position_number__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
...
template <class String> String insert_position_cstr_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_position_cstr_number__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, random1.size());
...
template <class String> String insert_position_cstr_number__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_position_cstr() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_position_cstr__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_position_cstr__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_iterator_char() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::value_type value = random('a', 'z');
...
template <class String> String insert_position_number_char() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
...
template <class String> String insert_iterator_iterator_iterator() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  std::list<typename String::value_type> list(
      RandomList<String>(MaxString<String>::value));
...
template <class String> String insert_iterator_iterator_iterator__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String insert_iterator_iterator_iterator__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String erase_position_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String erase_iterator() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  if (!random1.empty()) {
    const typename String::size_type position = random(0, random1.size());
...
template <class String> String erase_iterator_iterator() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
      random(position1, random1.size());
  random1.erase(random1.begin() + position1, random1.begin() + position2);
  return random1;
}

template <class String> String replace_position_number_string() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String replace_position_number_string__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
...
template <class String> String replace_position_number_string__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position = random(0, random1.size());
...
String replace_position_number_string_position_number() {
  ...
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type number1 =
      random(0, MaxString<String>::value);
  const typename String::size_type position2 = random(0, random2.size());
  const typename String::size_type number2 =
      random(0, MaxString<String>::value);
...
template <class String> String replace_position_number_cstr_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
...
template <class String> String replace_position_number_cstr_number__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type number1 =
...
template <class String> String replace_position_number_cstr_number__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position1 = random(0, random1.size());
...
template <class String> String replace_position_number_cstr() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
...
template <class String> String replace_position_number_cstr__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type number1 =
...
template <class String> String replace_position_number_cstr__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position1 = random(0, random1.size());
...
template <class String> String replace_position_number_number_char() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type number1 =
...
template <class String> String replace_iterator_iterator_string() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
      random(position1, random1.size());
  if (!random1.empty())
    random1.replace(random1.begin() + position1, random1.begin() + position2,
                    random2);
  else
...
template <class String> String replace_iterator_iterator_string__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String replace_iterator_iterator_string__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position1 = random(0, random1.size());
...
template <class String> String replace_iterator_iterator_cstr_number() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  ...
  if (!random1.empty())
    random1.replace(random1.begin() + position1, random1.begin() + position2,
                    random2.c_str(), number);
  else
    random1.replace(random1.begin(), random1.end(), random2.c_str(), number);
  return random1;
}

template <class String> String replace_iterator_iterator_cstr_number__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String replace_iterator_iterator_cstr() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
...
template <class String> String replace_iterator_iterator_cstr__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String replace_iterator_iterator_cstr__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String copy(random1);
  const typename String::size_type position1 = random(0, random1.size());
...
template <class String> String replace_iterator_iterator_number_char() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String replace_iterator_iterator_iterator_iterator() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
String replace_iterator_iterator_iterator_iterator__self() {
  ...
  const typename String::size_type position4 =
      random(position3, random1.size());
  random1.replace(random1.begin() + position1, random1.begin() + position2,
                  random1.begin() + position3, random1.begin() + position4);
  return random1;
}
...
String replace_iterator_iterator_iterator_iterator__selfcopy() {
  ...
  random1.replace(random1.begin() + position1, random1.begin() + position2,
                  copy.begin() + position3, copy.begin() + position4);
  return random1;
}
...
template <class String> String copy_char_number_position() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String swap() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
...
template <class String> String swap__self() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String swap__selfcopy() {
  // 21.3.5
  String random1(RandomString<String>(MaxString<String>::value));
...
template <class String> String string_operations() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String result;
  result += Num2String<String>(random1.c_str() == random1.data());
  result += Num2String<String>(NullTerminator<String>() ==
                               *(random1.c_str() + random1.size()));
  result +=
      Num2String<String>(random1.get_allocator() == result.get_allocator());
  return result;
}

template <class String> String find_string_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String find_string_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_cstr_position_number__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
  ...
  const typename String::size_type position3 = random(0, random1.size());
  String result;
  result = Num2String<String>(
      random1.find(searched.c_str(), position3, searched.size()));
  return result;
}

template <class String> String find_cstr_position_number__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  String result;
  result = Num2String<String>(
      random1.find(random2.c_str(), position, random2.size()));
  return result;
}

template <class String> String find_cstr_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String find_cstr_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_char_position() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::value_type value = random('a', 'z');
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String rfind_string_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String rfind_string_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String rfind_cstr_position_number__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
  ...
  String result;
  result = Num2String<String>(
      random1.rfind(searched.c_str(), position3, searched.size()));
  return result;
}

template <class String> String rfind_cstr_position_number__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  String result;
  result = Num2String<String>(
      random1.rfind(random2.c_str(), position, random2.size()));
  return result;
}

template <class String> String rfind_cstr_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String rfind_cstr_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String rfind_char_position() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::value_type value = random('a', 'z');
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_overflow() {
...
template <class String> String rfind_overflow() {
  String testString;
  String result;
...
template <class String> String find_first_of_string_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String find_first_of_string_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_first_of_cstr_position_number__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
  ...
  String result;
  result = Num2String<String>(
      random1.find_first_of(searched.c_str(), position3, searched.size()));
  return result;
}

template <class String> String find_first_of_cstr_position_number__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  String result;
  result = Num2String<String>(
      random1.find_first_of(random2.c_str(), position, random2.size()));
  return result;
}

template <class String> String find_first_of_cstr_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
  ...
  String result;
  result =
      Num2String<String>(random1.find_first_of(searched.c_str(), position3));
  return result;
}

template <class String> String find_first_of_cstr_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_first_of_char_position() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::value_type value = random('a', 'z');
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_last_of_string_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String find_last_of_string_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_last_of_cstr_position_number__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
  ...
  String result;
  result = Num2String<String>(
      random1.find_last_of(searched.c_str(), position3, searched.size()));
  return result;
}

template <class String> String find_last_of_cstr_position_number__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  String result;
  result = Num2String<String>(
      random1.find_last_of(random2.c_str(), position, random2.size()));
  return result;
}

template <class String> String find_last_of_cstr_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
  ...
  String result;
  result =
      Num2String<String>(random1.find_last_of(searched.c_str(), position3));
  return result;
}

template <class String> String find_last_of_cstr_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_last_of_char_position() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::value_type value = random('a', 'z');
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_first_not_of_string_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String find_first_not_of_string_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
String find_first_not_of_cstr_position_number__existing() {
  ...
  String result;
  result = Num2String<String>(
      random1.find_first_not_of(searched.c_str(), position3, searched.size()));
  return result;
}
...
String find_first_not_of_cstr_position_number__random() {
  ...
  String result;
  result = Num2String<String>(
      random1.find_first_not_of(random2.c_str(), position, random2.size()));
  return result;
}

template <class String> String find_first_not_of_cstr_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
  ...
  String result;
  result = Num2String<String>(
      random1.find_first_not_of(searched.c_str(), position3));
  return result;
}

template <class String> String find_first_not_of_cstr_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  String result;
  result =
      Num2String<String>(random1.find_first_not_of(random2.c_str(), position));
  return result;
}

template <class String> String find_first_not_of_char_position() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::value_type value = random('a', 'z');
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String find_last_not_of_string_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
...
template <class String> String find_last_not_of_string_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
String find_last_not_of_cstr_position_number__existing() {
  ...
  String result;
  result = Num2String<String>(
      random1.find_last_not_of(searched.c_str(), position3, searched.size()));
  return result;
}

template <class String> String find_last_not_of_cstr_position_number__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  String result;
  result = Num2String<String>(
      random1.find_last_not_of(random2.c_str(), position, random2.size()));
  return result;
}

template <class String> String find_last_not_of_cstr_position__existing() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type position2 =
  ...
  String result;
  result =
      Num2String<String>(random1.find_last_not_of(searched.c_str(), position3));
  return result;
}

template <class String> String find_last_not_of_cstr_position__random() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  String result;
  result =
      Num2String<String>(random1.find_last_not_of(random2.c_str(), position));
  return result;
}

template <class String> String find_last_not_of_char_position() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::value_type value = random('a', 'z');
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String substr_position_number() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
...
template <class String> String substr_position_number__overflow() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
...
template <class String> String substr_position_number__npos() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  String result;
...
template <class String> String compare_string() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String compare_string__same() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String compare_position_number_string() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
...
template <class String> String compare_position_number_string__same() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
...
String compare_position_number_string_position_number() {
  ...
  const typename String::size_type number2 =
      random(0, MaxString<String>::value);
  String result;
  result = Tristate2String<String>(
      random1.compare(position1, number1, random2, position2, number2));
  return result;
}
...
String compare_position_number_string_position_number__same() {
  ...
  String result;
  result = Tristate2String<String>(
      random1.compare(position, number, random1, position, number));
  return result;
}

template <class String> String compare_cstr() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String random2(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String compare_cstr__same() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  String result;
...
template <class String> String compare_position_number_cstr() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
  ...
  String result;
  result = Tristate2String<String>(
      random1.compare(position, number, random2.c_str()));
  return result;
}

template <class String> String compare_position_number_cstr__same() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
  ...
  String result;
  result =
      Tristate2String<String>(random1.compare(position, number, same.c_str()));
  return result;
}

template <class String> String compare_position_number_cstr_number() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position1 = random(0, random1.size());
  const typename String::size_type number1 =
  ...
  String result;
  result = Tristate2String<String>(
      random1.compare(position1, number1, random2.c_str(), number2));
  return result;
}

template <class String> String compare_position_number_cstr_number__same() {
  // 21.3.6
  String random1(RandomString<String>(MaxString<String>::value));
  const typename String::size_type position = random(0, random1.size());
  const typename String::size_type number = random(0, MaxString<String>::value);
  String result;
  result = Tristate2String<String>(
      random1.compare(position, number, random1.c_str(), number));
  return result;
}

} // namespace Tests

template <class String> class TestFunctions {
public:
...
#define ADD_TEST(test)                                                         \
  (testFunctions.push_back(std::make_pair((#test), (test<String>))))
  ...
  ~TestFunctions() { testFunctions.clear(); }
...
void checkResults(const std::string &reference, const String &tested,
  ...
  if ((tested.size() != reference.size()) ||
    ...
    std::cout << "\n\nTest #" << testFunctions.getNumberInTestRange(count)
              << " \"" << testFunctions.getTestName(count)
              << "\" failed for string type \"" << typeid(String).name()
              << "\":\n"
...
void Compare() {
  ...
  TestFunctions<my_string_SmallStringSimpleBigBuffer>
      testFunctions_smallStringSimpleBigBuffer;
  ...
  for (;;) {
    ...
    {
      srand(seedForThisIteration);
      const my_string_SimpleStorage tested(
          Test<my_string_SimpleStorage>(count, testFunctions_SimpleStorage));
      checkResults(reference, tested, testFunctions_SimpleStorage,
                   seedForThisIteration, count);
    }

    {
      srand(seedForThisIteration);
      const my_string_AllocatorStorage tested(Test<my_string_AllocatorStorage>(
          count, testFunctions_AllocatorStorage));
      checkResults(reference, tested, testFunctions_AllocatorStorage,
                   seedForThisIteration, count);
    }

    {
      srand(seedForThisIteration);
      const my_string_MallocatorStorage tested(
          Test<my_string_MallocatorStorage>(count,
                                            testFunctions_MallocatorStorage));
      checkResults(reference, tested, testFunctions_MallocatorStorage,
                   seedForThisIteration, count);
    }

    {
      srand(seedForThisIteration);
      const my_string_VectorStorage tested =
          Test<my_string_VectorStorage>(count, testFunctions_VectorStorage);
      checkResults(reference, tested, testFunctions_VectorStorage,
                   seedForThisIteration, count);
    }

    {
      srand(seedForThisIteration);
      const my_string_SmallStringSimple tested(
          Test<my_string_SmallStringSimple>(count,
                                            testFunctions_SmallStringSimple));
      checkResults(reference, tested, testFunctions_SmallStringSimple,
                   seedForThisIteration, count);
    }

    {
      srand(seedForThisIteration);
      const my_string_SmallStringSimpleBigBuffer tested(
          Test<my_string_SmallStringSimpleBigBuffer>(
              count, testFunctions_smallStringSimpleBigBuffer));
      checkResults(reference, tested, testFunctions_smallStringSimpleBigBuffer,
                   seedForThisIteration, count);
    }

    {
      srand(seedForThisIteration);
      const my_string_SmallStringVector tested(
          Test<my_string_SmallStringVector>(count,
                                            testFunctions_SmallStringVector));
      checkResults(reference, tested, testFunctions_SmallStringVector,
                   seedForThisIteration, count);
    }

    {
      srand(seedForThisIteration);
      const my_string_CowSimple tested(
          Test<my_string_CowSimple>(count, testFunctions_CowSimple));
      checkResults(reference, tested, testFunctions_CowSimple,
                   seedForThisIteration, count);
    }

    {
      srand(seedForThisIteration);
      const my_string_CowAllocator tested(
          Test<my_string_CowAllocator>(count, testFunctions_CowAllocator));
      checkResults(reference, tested, testFunctions_CowAllocator,
                   seedForThisIteration, count);
    }
  }
}
