...
typedef Loki::StrongPtr<Thingy, true, TwoRefCounts, DisallowConversion,
                        AssertCheck, CantResetWithStrong, DeleteSingle,
                        DontPropagateConst>
    Thingy_DeleteSingle_ptr;

typedef Loki::StrongPtr<Thingy, true, TwoRefCounts, DisallowConversion,
                        AssertCheck, CantResetWithStrong, DeleteUsingFree,
                        DontPropagateConst>
    Thingy_DeleteUsingFree_ptr;

typedef Loki::StrongPtr<Thingy, true, TwoRefCounts, DisallowConversion,
                        AssertCheck, CantResetWithStrong, DeleteNothing,
                        DontPropagateConst>
...
class Counted {
public:
  Counted(void) : m_size(0) { s_constructions++; }

  ~Counted(void) { s_destructions++; }
  ...
  static inline unsigned int GetCtorCount(void) { return s_constructions; }

  static inline unsigned int GetDtorCount(void) { return s_destructions; }
...
typedef Loki::StrongPtr<Earth, true, TwoRefCounts, DisallowConversion,
                        AssertCheck, AllowReset, DeleteSingle,
                        DontPropagateConst>
    Earth_StrongPtr;
...
class Earth {
public:
  Earth(void) : m_moon() { s_constructions++; }

  ~Earth(void) { s_destructions++; }
...
class Moon {
public:
  Moon(void) : m_earth() { s_constructions++; }

  ~Moon(void) { s_destructions++; }
...
void Moon::SetEarth(const Earth_WeakPtr &p) { m_earth = p; }

// ----------------------------------------------------------------------------

void Moon::SetEarth(const Earth_StrongPtr &p) { m_earth = p; }

// ----------------------------------------------------------------------------

void Earth::SetMoon(const Moon_WeakPtr &p) { m_moon = p; }

// ----------------------------------------------------------------------------

void Earth::SetMoon(const Moon_StrongPtr &p) { m_moon = p; }
...
typedef Loki::StrongPtr<BaseClass, true, TwoRefCounts, DisallowConversion,
                        NoCheck, CantResetWithStrong, DeleteSingle,
                        DontPropagateConst>
...
typedef Loki::StrongPtr<const BaseClass, false, TwoRefCounts,
                        DisallowConversion, AssertCheck, CantResetWithStrong,
                        DeleteSingle, PropagateConst>
...
void DoStrongRefCountTests(void) {
  ...
  {
    NonConstBase_StrongCount_NoConvert_NoCheck_NoPropagate_ptr s1(
        new BaseClass);
    NonConstBase_StrongCount_NoConvert_NoCheck_NoPropagate_ptr s2(
        new BaseClass);
    assert(s1 != s2);
    assert(s1);
    assert(s2);
...
void DoStrongReleaseTests(void) {
...

  {
    ...
    NonConstBase_WeakCount_NoConvert_Assert_Reset_NoPropagate_ptr w1(
        new BaseClass);
    NonConstBase_StrongCount_NoConvert_NoCheck_Reset_NoPropagate_ptr w2(
        new BaseClass);
...
class Ball {
public:
  inline static unsigned int GetCtorCount(void) { return s_CtorCount; }

  inline static unsigned int GetDtorCount(void) { return s_DtorCount; }

  inline static bool AllDestroyed(void) { return (s_CtorCount == s_DtorCount); }

  inline Ball(void) { s_CtorCount++; }

  inline ~Ball(void) { s_DtorCount++; }
...
// These typedefs are for testing StrongPtr ownership policies that enforce a
// single owner.
typedef ::Loki::StrongPtr<Ball, false, ::Loki::SingleOwnerRefCount,
                          ::Loki::DisallowConversion, ::Loki::AssertCheck,
                          ::Loki::OnlyStrongMayReset>
...
template <class OwnerPtr, class NonOwnerPtr> class TheOwner {
public:
  ...
  void UseBall(const OwnerPtr &ball) { m_otherBall = ball; }
  ...
  const OwnerPtr &ShareMyBall(void) const { return m_myBall; }

  const NonOwnerPtr &ShareOtherBall(void) { return m_otherBall; }
...
typedef TheOwner<Lockable_Owner_Counted_BallPtr,
                 Lockable_NonOwner_Counted_BallPtr>
    Teenager;
...
void DoSingleOwnerTest(OwnerPtr &op1, const NonOwnerPtr &pBall1,
                       const NonOwnerPtr &pBall2, const NonOwnerPtr &pBall3,
  ...
  try {
    ...
    assert(true);
    assert(::strcmp(ex.what(),
                    ::Loki::StrongPtr_Single_Owner_Exception_Message) == 0);
    (void)ex;
  }
  try {
    assert(owner3.ShareMyBall() == pBall3);
...
void DoSingleOwnerTests(void) {
  ...
  // These tests exercise the lockable single-owner StrongPtr policies.
  {
    ...
    Teenager teen2;
    Teenager teen3;
    DoSingleOwnerTest(op1, pBaseball, pFootball, pSoftball, teen1, teen2,
                      teen3);
  }
  assert(Ball::AllDestroyed());
  ...
  // These tests exercise the reference-counted single-owner StrongPtr policies.
  {
    ...
    DoSingleOwnerTest(op1, pSoccerBall, pBouncyBall, pBasketBall, child1,
                      child2, child3);
  }
  assert(Ball::AllDestroyed());
  ...
  // These tests exercise the linked-cycle single-owner StrongPtr policies.
  {
    ...
    DoSingleOwnerTest(op1, pYarnBall, pTwineBall, pStringBall, cat1, cat2,
                      cat3);
  }
  assert(Ball::AllDestroyed());
}
...
void DoStrongPtrDynamicCastTests(void) {
  ...
  typedef ::Loki::StrongPtr<Feline, true, ::Loki::LockableTwoRefCounts>
      FelineLockPtr;
  typedef ::Loki::StrongPtr<Tiger, true, ::Loki::LockableTwoRefCounts>
      TigerLockPtr;
  typedef ::Loki::StrongPtr<Lion, true, ::Loki::LockableTwoRefCounts>
      LionLockPtr;
...
struct BugGcc :
  ...
  template <int I2, class P2> BugGcc(const BugGcc<I2, P2> &t) : P(t) {}
};
...
typedef Loki::StrongPtr<Tiger, true, TwoRefCounts, DisallowConversion,
                        AssertCheck, CantResetWithStrong, DeleteArray,
                        DontPropagateConst>
