...
bool NoCheckRequired(void) { return true; }

// ----------------------------------------------------------------------------

BoolReturn CheckRequired(void) { return BoolReturn(true); }

// ----------------------------------------------------------------------------

BoolReturnStderr CheckRequiredStderr(void) { return BoolReturnStderr(true); }
...
string GetString(void) { return string("a"); }

// ----------------------------------------------------------------------------

StringReturn MustUseString(const char *s) { return StringReturn(s); }

// ----------------------------------------------------------------------------

void StringEater(const string &s) { (void)s; }
...
int main(int argc, const char *argv[]) {
  ...
  if (2 == argc) {
...

    {
      ...
      cout << "Called MustUseString and passed return value into another "
              "function."
           << endl;
    }
